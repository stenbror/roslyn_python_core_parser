...
pub enum SyntaxNode {
    ...
    ClassPatternNode(u32, u32, Vec<Box<SyntaxNode>>, Vec<Box<Token>>, Box<Token>, Vec<Box<SyntaxNode>>, Vec<Box<Token>>,  Box<Token>),
    ...
    StarPatternNode(u32, u32, Box<Token>, Box<SyntaxNode>),
